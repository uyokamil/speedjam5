using GrappleGod.Scripts.Player.Abilities;
using TMPro;
using UnityEditor.ShaderGraph.Internal;
using UnityEngine;

namespace GrappleGod.Scripts.Player
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        private void ShowDebugText()
        {
            ...
            text_mode.SetText(playerState.ToString());
        }
